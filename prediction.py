...
#    age = st.number_input('Age:',min_value=1,max_value=122)
    race = st.selectbox('College Major:',options=['Asian','Arab','Black','Indigenous Australian','Native American','White','Other'])
    gender = st.selectbox('College Major:',options=['Male','Female','Other'])
    religion = st.selectbox('College Major:',options=['Agnostic','Atheist','Buddhist','Christian (Catholic)',
